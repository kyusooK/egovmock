...
function EgovNoticeDetail(props) {
    ...
    const retrieveDetail = () => {
        const retrieveDetailURL = `/testAggs/${id}`;
    ...
    function fetchTestAgg(id){
        axios.get(`/testAggs/${id}`)
        .then(response => {
    ...
    function deleteList(){
        axios.delete(`/testAggs/${id}`)
        navigate('/delivery/testAggs');
    }
            ...
            <div className="c_wrap">
                ...
                <div className="location">
                    <ul>
                        ...
                        <li><Link to="/delivery/testAggs">TestAgg</Link></li>
